...
import { submitVolunteerApplication } from '@/app/(app)/_actions/submitApplication';
        ...
        <div className="w-full">
            <div className="text-center mb-12">
                ...
                <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                    Fill out the form below to express your interest in volunteering with LIFE-MAC Africa. We'll get back to
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div className="grid md:grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        ...
                                        <Input id="firstName" name="firstName" required className="bg-white/10 border-white/20 text-white placeholder:text-white/60 h-12 rounded-xl focus:bg-white/20 focus:border-white/40 transition-colors" />
                                    </div>
                                    <div className="space-y-2">
                                        <Label htmlFor="lastName" className="text-white font-medium">Last Name *</Label>
                                        <Input id="lastName" name="lastName" required className="bg-white/10 border-white/20 text-white placeholder:text-white/60 h-12 rounded-xl focus:bg-white/20 focus:border-white/40 transition-colors" />
                                    </div>
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Input id="address" name="address" className="bg-white/10 border-white/20 text-white placeholder:text-white/60 h-12 rounded-xl focus:bg-white/20 focus:border-white/40 transition-colors" />
                                </div>

                                <div className="space-y-2">
                                    <Label htmlFor="skills" className="text-white font-medium">Skills & Experience</Label>
                                    <Textarea
                                        id="skills"
                                        name="skills"
                                ...
                                <div className="flex items-start space-x-3">
                                    ...
                                    <div className="grid md:gap-1.5 leading-none">
                                ...
                                <div className="flex items-start space-x-3">
                                    ...
                                    <div className="grid md:gap-1.5 leading-none">
                                        <Label htmlFor="terms" className="text-sm leading-snug text-white/90 font-normal">
                                            I agree to the <Link href="#" className="text-[#EAB308] hover:text-white hover:underline font-medium">
