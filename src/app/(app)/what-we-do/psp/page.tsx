        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8 relative z-10">
              <div className="space-y-2 z-40 leading-snug">
                <h1 className="text-5xl md:text-7xl font-bold text-[#0B1C3E] tracking-tight ">
                  Paradigm Shift
                </h1>
                <h2 className="text-5xl md:text-7xl font-bold text-[#0B1C3E]">
                  Project (PSP)
                </h2>
              </div>
              
              <p className="text-lg md:text-xl text-[#0B1C3E]/80 max-w-lg leading-relaxed">
             PSP is a structured mentorship initiative designed to redefine how students see themselves and their future. It focuses on personal growth, academic excellence, and career exploration. 
              </p>
        ...
        <div className="max-w-[110rem] mx-auto px-4 sm:px-6 lg:pr-24">
            ...
            <div className="grid md:grid-cols-2 md:gap-12 items-center py-12">
              ...
              <div className="prose max-w-none">
                <h3 className="text-2xl font-bold text-[#0B1C3E] mb-6">We aim to:</h3>
                <ul className="space-y-4">
                  {[
                    { title: "Build Personal Mastery", desc: "Developing self-confidence, emotional intelligence, and decisive decision-making skills." },
                    { title: "Enhance Academic Performance", desc: "Providing guidance on learning strategies to improve school outcomes." },
                    { title: "Clarify Career Pathways", desc: "Exposing students to diverse industries to help them define their aspirations." },
                    { title: "Cultivate Critical Thinking", desc: "Sharpening problem-solving skills for real-world challenges." },
                    { title: "Drive Goal Setting", desc: "Guiding students to set and achieve actionable personal and professional milestones." }
                  ].map((item, index) => (
                    ...
                    <div className="relative bg-white p-8 md:p-12 rounded-3xl shadow-2xl max-w-2xl z-20 mx-4 text-center border border-gray-100">
                      ...
                      <div className="grid grid-cols-2 gap-8">
                        <div className="flex flex-col items-center">
                          <span className="text-4xl md:text-5xl font-bold text-[#EAB308] mb-2">3,362</span>
                          <span className="text-sm md:text-base font-medium text-[#0B1C3E] uppercase tracking-wide">Learners Engaged</span>
                        </div>
                        <div className="flex flex-col items-center">
                          <span className="text-4xl md:text-5xl font-bold text-[#EAB308] mb-2">32</span>
                          <span className="text-sm md:text-base font-medium text-[#0B1C3E] uppercase tracking-wide">Partner Schools</span>
                        </div>
                        <div className="flex flex-col items-center">
                          <span className="text-4xl md:text-5xl font-bold text-[#EAB308] mb-2">189</span>
                          <span className="text-sm md:text-base font-medium text-[#0B1C3E] uppercase tracking-wide">Mentors Deployed</span>
                        </div>
                        <div className="flex flex-col items-center">
                          <span className="text-4xl md:text-5xl font-bold text-[#EAB308] mb-2">17</span>
                          <span className="text-sm md:text-base font-medium text-[#0B1C3E] uppercase tracking-wide">Mentoring Sessions</span>
                        </div>
                      </div>
                    </div>
                ...
                <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
                  ...
                  <div className="space-y-6">
                    {events.length > 0 ? (
                      ...
                      <p className="text-gray-500 text-center py-4">No upcoming PSP events. Check back soon!</p>
                    )}
                  </div>
                </div>
