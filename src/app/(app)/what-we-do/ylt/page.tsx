          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8 relative z-10">
              <div className="space-y-2">
                <h1 className="text-5xl md:text-7xl font-bold text-[#0B1C3E] tracking-tight leading-snug">
              ...
              <p className="text-lg md:text-xl text-[#0B1C3E]/80 max-w-lg leading-relaxed">
                YLT is an interactive peer-learning capacity-building initiative designed for tertiary students and young professionals. Rooted in the Japanese philosophy of Kaizen (continuous improvement), the project operates on a simple premise: to stay relevant in an evolving job market, learning must never stop.
              </p>
            ...
            <div className="grid md:grid-cols-2 md:gap-12 items-center py-12">
              ...
              <div className="prose max-w-none">
                ...
                <ul className="space-y-4">
                  {[
                    { title: "Continuous Improvement", desc: "Fostering a mindset of lifelong learning and adaptation." },
                    { title: "Future-Ready Skills", desc: "Equipping participants with the specific tools needed to navigate the modern gig economy and professional landscape." },
                    { title: "Collaborative Growth", desc: "Creating a supportive ecosystem where peers and experts exchange insights to solve problems collectively." },
                    { title: "Strategic Networking", desc: "Facilitating meaningful connections with industry leaders and mentors to unlock professional opportunities and build social capital." }
                  ].map((item, index) => (
                  ...
                  <div className="relative h-[600px] md:h-[500px] w-full flex items-center justify-center">
                    ...
                    <div className="relative bg-white p-8 md:p-12 rounded-3xl shadow-2xl max-w-2xl z-20 mx-4 text-center border border-gray-100">
                      ...
                      <p className="text-lg text-[#0B1C3E]/80 mb-8">
                        We have successfully built a community of practice across 1 Region, connecting learners with industry experts.
                      </p> */}
                      
                      <div className="grid grid-cols-2 gap-8">
                        <div className="flex flex-col items-center">
                          <span className="text-4xl md:text-5xl font-bold text-[#EAB308] mb-2">519</span>
                          <span className="text-sm md:text-base font-medium text-[#0B1C3E] uppercase tracking-wide">Participants Upskilled</span>
                        </div>
                        <div className="flex flex-col items-center">
                          <span className="text-4xl md:text-5xl font-bold text-[#EAB308] mb-2">17</span>
                          <span className="text-sm md:text-base font-medium text-[#0B1C3E] uppercase tracking-wide">Interactive Sessions</span>
                        </div>
                        <div className="flex flex-col items-center col-span-2">
                          <span className="text-4xl md:text-5xl font-bold text-[#EAB308] mb-2">16</span>
                          <span className="text-sm md:text-base font-medium text-[#0B1C3E] uppercase tracking-wide">Resource Persons Deployed</span>
                        </div>
                      </div>
                    </div>
                ...
                <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
                  ...
                  <div className="space-y-6">
                    {events.length > 0 ? (
                      ...
                      <p className="text-gray-500 text-center py-4">No upcoming YLT events. Check back soon!</p>
                    )}
                  </div>
                </div>
      ...
      <section className="relative py-24 overflow-hidden bg-[#FDF8F3] z-0">
        ...
        <div className="container relative z-10 mx-auto px-4 text-center pb-28">
          ...
          <p className="max-w-2xl mx-auto mb-10 text-lg md:text-xl text-[#0B1C3E]/80 leading-relaxed">
            Your support can help us reach more students and mentor them in key areas of their development.
          </p>
