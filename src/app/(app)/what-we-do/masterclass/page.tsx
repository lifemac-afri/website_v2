...
const Masterclass = async () => {
  ...
  // Fetch Gallery Images for Masterclass
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8 relative z-30">
              ...
              <p className="text-lg md:text-xl text-[#0B1C3E]/80 max-w-lg leading-relaxed">
                Masterclass is our dedicated digital learning platform designed to democratize access to high-level expertise. Recognizing that physical location should not be a barrier to knowledge, this initiative leverages digital tools to connect industry leaders directly with young people across the continent.
              </p>
            ...
            <div className="relative h-[600px] hidden lg:block">
              ...
              <div className="absolute top-0 left-0 w-[45%] h-[85%] bg-gray-200 rounded-[3rem] overflow-hidden shadow-xl z-10">
                <Image
                  src="/images/masterclass/mc4.jpg"
                  alt="STEMIZE Project"
                  fill
              ...
              <div className="absolute top-10 right-0 w-[45%] h-[45%] bg-gray-200 rounded-[3rem] overflow-hidden shadow-xl">
                <Image
                  src="/images/masterclass/mc2.jpg"
                  alt="STEM Education"
                  fill
              ...
              <div className="absolute bottom-0 right-10 w-[45%] h-[35%] bg-gray-200 rounded-[3rem] overflow-hidden shadow-xl">
                <Image
                  src="/images/masterclass/mc3.jpg"
                  alt="Xplore Bot"
                  fill
                  className="object-cover"
                />
        ...
        <div className="max-w-[110rem] mx-auto px-4 sm:px-6 lg:pr-24">
          ...
          <div className="grid md:grid-cols-2 md:gap-12 items-center py-12">
            <div className="relative h-[400px] md:h-[700px] w-full flex items-center justify-center -mt-20 ">
              ...
              >
                <Image
                  src="/images/masterclass/mc6.jpg"
            ...
            <div className="prose max-w-none">
              ...
              <ul className="space-y-4">
                {[
                  { title: "Borderless Access", desc: " Leveraging digital tools to remove geographical barriers to high-quality education." },
                  { title: "Expert-Led Insight", desc: "Providing direct access to seasoned professionals, industry veterans, and thought leaders." },
                  { title: "Scalable Impact", desc: "Utilizing technology to efficiently expand our reach and maximize beneficiary outcomes." }
                ].map((item, index) => (
                ...
                <div className="relative h-[600px] md:h-[500px] w-full flex items-center justify-center">
                  ...
                  <div className="absolute top-0 left-0 md:left-10 w-48 h-48 md:w-64 md:h-64  transform -rotate-6 z-10">
                    <div className="relative w-full h-full rounded-xl overflow-hidden shadow-lg border-4 border-white">
                      <Image
                        src="/images/masterclass/mc1.jpg"
                        alt="Girls education"
                        fill
                        className="object-cover"
                      />
                  ...
                  <div className="absolute -top-36 right-0 md:right-10 w-64 h-40 md:w-96 md:h-48 transform rotate-6 z-0">
                    <div className="relative w-full h-full rounded-xl overflow-hidden">
                      <Image
                        src="/images/masterclass/mc5.jpg"
                        alt="Empowerment"
                        fill
                        className="object-cover"
                      />
                  ...
                  <div className="relative bg-white p-8 md:p-12 rounded-3xl shadow-2xl max-w-2xl z-20 mx-4 text-center border border-gray-100">
                    <div className="grid grid-cols-2 gap-8">
                      <div className="flex flex-col items-center">
                        <span className="text-4xl md:text-5xl font-bold text-[#EAB308] mb-2">392</span>
                        <span className="text-sm md:text-base font-medium text-[#0B1C3E] uppercase tracking-wide">Digital Learners</span>
                      </div>
                      <div className="flex flex-col items-center">
                        <span className="text-4xl md:text-5xl font-bold text-[#EAB308] mb-2">11</span>
                        <span className="text-sm md:text-base font-medium text-[#0B1C3E] uppercase tracking-wide">Virtual Sessions</span>
                      </div>
                      <div className="flex flex-col items-center col-span-2">
                        <span className="text-4xl md:text-5xl font-bold text-[#EAB308] mb-2">3</span>
                        <span className="text-sm md:text-base font-medium text-[#0B1C3E] uppercase tracking-wide">Countries Reached</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="absolute bottom-0 right-0 md:right-10 w-48 h-48 md:w-64 md:h-64 transform rotate-6 z-10">
                    <div className="relative w-full h-full rounded-xl overflow-hidden">
                      <Image
                        src="/images/masterclass/mc7.jpg"
                        alt="STEM Workshop"
                        fill
                        className="object-cover"
                      />
            ...
            <div className="space-y-8 z-20">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
                ...
                <div className="space-y-6">
                  {events.length > 0 ? (
                    ...
                    <p className="text-gray-500 text-center py-4">No upcoming masterclass events. Check back soon!</p>
                  )}
                </div>
              </div>
              ...
              <Card className="bg-[#0B1C3E] text-white border-none shadow-lg relative overflow-hidden z-20 ">
                ...
                <CardHeader>
                  ...
                  <CardDescription className="text-blue-200">Have questions about the Masterclass Program?</CardDescription>
                </CardHeader>
                <CardContent>
